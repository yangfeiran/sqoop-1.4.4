...
public abstract class BaseSqoopTool extends com.cloudera.sqoop.tool.SqoopTool {
    ...
    public static final String INCREMENT_LAST_TYPE_ARG = "last-type";
    ...
    protected RelatedOptions getCommonOptions() {
        ...
        commonOpts
                .addOption(OptionBuilder.withArgName("class-name").hasArg()
    ...
    protected RelatedOptions getHiveOptions(boolean explicitHiveImport) {
        ...
        if (explicitHiveImport) {
            hiveOpts.addOption(OptionBuilder
                    .withDescription("Import tables into Hive " + "(Uses Hive's default delimiters if none are set.)")
        ...
        hiveOpts.addOption(OptionBuilder.hasArg()
                .withDescription("Override mapping for specific column to hive" + " types.")
    ...
    protected RelatedOptions getHCatalogOptions() {
        ...
        hCatOptions.addOption(OptionBuilder.hasArg().withDescription("HCatalog table name")
                .withLongOpt(HCATALOG_TABLE_ARG).create());
    ...
    protected RelatedOptions getInputFormatOptions() {
        ...
        inputFormatOpts
                .addOption(OptionBuilder.withArgName("char").hasArg()
                        .withDescription("Sets the input end-of-line char").withLongOpt(INPUT_LINES_TERMINATED_BY_ARG)
                        .create());
        inputFormatOpts.addOption(OptionBuilder.withArgName("char").hasArg()
                .withDescription("Sets a field enclosing character").withLongOpt(INPUT_OPTIONALLY_ENCLOSED_BY_ARG)
                .create());
        inputFormatOpts.addOption(OptionBuilder.withArgName("char").hasArg()
    ...
    protected RelatedOptions getCodeGenOpts(boolean multiTable) {
        ...
        codeGenOpts.addOption(OptionBuilder.hasArg()
                .withDescription("Override mapping for specific columns to java types").withLongOpt(MAP_COLUMN_JAVA)
                .create());
        ...
        if (!multiTable) {
            codeGenOpts.addOption(OptionBuilder
                    ...
                    .hasArg()
                    .withDescription(
                            "Sets the generated class name. " + "This overrides --" + PACKAGE_NAME_ARG
    ...
    protected void applyValidationOptions(CommandLine in, SqoopOptions out) throws InvalidOptionsException {
        ...
        if (in.hasOption(VALIDATION_FAILURE_HANDLER_CLASS_ARG)) {
            out.setValidationFailureHandlerClass(getClassByName(in.getOptionValue(VALIDATION_FAILURE_HANDLER_CLASS_ARG)));
        }
    }
    ...
    protected void validateHiveOptions(SqoopOptions options) throws InvalidOptionsException {
        ...
        if (options.doHiveImport()
                && ((options.getWarehouseDir() != null && options.getWarehouseDir().startsWith(defaultHiveWarehouse)) || (options
                        .getTargetDir() != null && options.getTargetDir().startsWith(defaultHiveWarehouse)))) {
        ...
        if (!options.doHiveImport()
                && ((options.getHiveHome() != null && !options.getHiveHome().equals(SqoopOptions.getHiveHomeDefault()) && hCatTable == null))
                || options.doOverwriteHiveTable() || options.doFailIfHiveTableExists()
                || (options.getHiveTableName() != null && !options.getHiveTableName().equals(options.getTableName()))
    ...
    protected void validateHBaseOptions(SqoopOptions options) throws InvalidOptionsException {
        if ((options.getHBaseColFamily() != null && options.getHBaseTable() == null)
            ...
            throw new InvalidOptionsException("Both --hbase-table and --column-family must be set together." + HELP_STR);
        }

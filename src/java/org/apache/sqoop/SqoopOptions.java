...
public class SqoopOptions implements Cloneable {
    ...
    @StoredAsProperty("incremental.last.type")
    private String incrementalLastType;
            ...
            for (Field f : fields) {
                if (f.isAnnotationPresent(StoredAsProperty.class)) {
                    ...
                    if (typ.equals(int.class)) {
                        ...
                        String value = props.getProperty(propName, f.get(this) == null ? "null" : f.get(this)
                                .toString());
    ...
    private void loadPasswordProperty(Properties props) {
        ...
        if (passwordFilePath != null) {
            try {
                password = CredentialsUtil.fetchPasswordFromFile(getConf(), passwordFilePath);
    ...
    public String getIncrementalLastType() {

        return incrementalLastType;

    }

    public void setIncrementalLastType(String incrementalLastType) {

        this.incrementalLastType = incrementalLastType;
